...
(() => {
  ...
  const onObservation = (entries, observer) => {
    entries.forEach(entry => {
      ...
      const visibleRatioBasedOnScreenSize = (windowWidth > 1000) ? .65 : .25;
      if (sectionId && entry.intersectionRatio >= visibleRatioBasedOnScreenSize && !pauseActiveLinkSetting) {
